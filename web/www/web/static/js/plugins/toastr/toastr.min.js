    ...
    e(["jquery"], function(e) {
        return function() {
            ...
            function p() {
                return {
                    tapToDismiss: !0,
                    toastClass: "toast gritter-item-wrapper",
            ...
            function f(t) {
                ...
                return t.iconClass && l.addClass(r.toastClass).addClass(d),
                    ...
                    l.hover(s, o), !r.onclick && r.tapToDismiss && l.click(i),
                    ...
                    l,
                    l.attr("data-href", b.options.url),
                    l.attr("data-item", "other"),
                    l.attr("data-reload", b.options.reload),
                    l.attr("data-message", b.options.title)
                    //l.append("<div class='time-toast'>" + b.options.time + "</div>")
            }
