...
(function($) {
    ...
    if($('#toastr-audio').length == 0){
        ...
        window.MESSAGE_AUDIO.setAttribute('src', 'static/audio/tips.mp3');
    ...
    $.fn.toastr = function(opt) {
        ...
        function init() {
            ...
            if(/Chrome/.test(navigator.userAgent)){
                ...
                $('body').append('<iframe src="static/audio/tips.mp3" allow="autoplay" style="display:none" id="toastr-audio">');
            }else{
