                ...
                <form class="form-horizontal" id="validateForm" novalidate="novalidate" action="" method="POST">
                    ...
                    <div class="widget-content">
                        ...
                        <div class="form-group">
                            <label class="col-sm-2 control-label"><code>*</code> 授权名称:</label>
                            <div class="col-sm-10">
                                <input name="name" type="text" class="form-control" datatype="*" nullmsg="请输入授权名称" value="<{$v.name}>"/>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <label class="col-sm-2 control-label"><code>*</code> 授权域(scope):</label>
                            <div class="col-sm-10">
                                <input name="scope" type="text" class="form-control" datatype="*" nullmsg="请输入授权域" value="<{$v.scope}>"/>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <label class="col-sm-2 control-label"><code>*</code> 默认授权:</label>
                            <div class="col-sm-10">
                                <div class="radio">
                                    <label>
                                        <input type="radio" value="1" name="is_default" <{if $v.is_default==1}>checked<{/if}> /> 是
                                    </label>
                                    <label>
                                        <input type="radio" value="0" name="is_default" <{if $v.is_default==0}>checked<{/if}> /> 否
                                    </label>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <label class="col-sm-2 control-label"> 授权说明:</label>
                            <div class="col-sm-10">
                                <input name="desc" type="text" class="form-control" value="<{$v.desc}>" />
                            </div>
                        </div>
