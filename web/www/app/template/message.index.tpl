            ...
            <div class="widget-box">
                ...
                <div class="widget-content p-b-none">
                    <div class="btn-outline-wrap">
                        <a href="?ct=message&ac=index" class="btn btn-success"><i class="fa fa-bars"></i>消息列表</a>
                        <a href="?ct=message&ac=add" class="btn btn-info btn-outline"><i class="fa fa-plus-circle"></i>消息添加</a>
                    ...
                    <table class="table table-bordered table-hover table-agl-c with-check">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td> 
                                    <a href="?ct=message&ac=info&id=<{$v.id}>" class="btn btn-success btn-xs"><i class="fa fa-search"></i>查看</a>
                                    <a href="?ct=message&ac=edit&id=<{$v.id}>" class="btn btn-primary btn-xs"><i class="fa fa-edit"></i>修改</a>
                                    <a onclick="plt.confirmAction(event)" data-href="?ct=message&ac=del&ids[]=<{$v.id}>" data-title="确认删除" data-tipmsg="确认删除" class="btn btn-danger btn-xs"><i class="fa fa-trash-o"></i>删除</a>
                                </td>
                            </tr>
                            <{foreachelse}>
                            <tr>
...
$('.ajax-post-test').click(function(){
    ...
    $.post("?ct=message&ac=ajax_post",{suggest:'jjjjj'},function(result){
        console.log(result);
    });
