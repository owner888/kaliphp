                ...
                <form class="form-horizontal" id="validateForm" novalidate="novalidate" action="" method="POST">
                    ...
                    <div class="widget-content">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input name="name" type="text" class="form-control" datatype="*" nullmsg="请输入应用名称" value="<{$v.name}>" />
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input name="website" type="text" class="form-control" datatype="*" nullmsg="请输入应用官网" value="<{$v.website}>" />
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input name="client_id" type="text" class="form-control" value="<{$v.client_id}>" readonly />
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <div class="input-group">
                                    <input name="client_secret" type="text" class="form-control" value="<{$v.client_secret}>" readonly />
                                    <span class="input-group-btn"> <button type="button" class="btn btn-success client_secret_reset">重置</button> </span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input name="desc" type="text" class="form-control" datatype="*" nullmsg="请输入应用简介" value="<{$v.desc}>" />
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input name="redirect_uri" type="text" class="form-control" datatype="*" nullmsg="请输入安全域名" value="<{$v.redirect_uri}>" />
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input name="cancel_uri" type="text" class="form-control" value="<{$v.cancel_uri}>" />
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input name="domain" type="text" class="form-control" datatype="*" nullmsg="请输入域名" value="<{$v.domain}>" />
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input name="ip" type="text" class="form-control" datatype="*" nullmsg="请输入IP" value="<{$v.ip}>" />
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <div class="checkbox">
                                    <{foreach from=$scopes item='vv'}>
                                    <label>
                                        <input type="checkbox" name="scope[]" value="<{$vv.scope}>" <{if in_array($vv.scope, $v.scope)}>checked<{/if}> /> <{$vv.name}>
                                    </label>
                                    <{/foreach}>
                                </div>
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <div class="checkbox">
                                    <label>
                                        <input type="checkbox" name="grant_types[]" value="authorization_code" <{if in_array('authorization_code', $v.grant_types)}>checked<{/if}> /> 授权码
                                    </label>
                                    <label>
                                        <input type="checkbox" name="grant_types[]" value="refresh_token" <{if in_array('refresh_token', $v.grant_types)}>checked<{/if}> /> 刷新Token
                                    </label>
                                    <label>
                                        <input type="checkbox" name="grant_types[]" value="password" <{if in_array('password', $v.grant_types)}>checked<{/if}> /> 用户口令
                                    </label>
                                    <label>
                                        <input type="checkbox" name="grant_types[]" value="client_credentials" <{if in_array('client_credentials', $v.grant_types)}>checked<{/if}> /> 应用授权
                                    </label>
                                </div>
                            </div>
                        </div>
...
$(".client_secret_reset").click(function(){
    $.getJSON("?ct=oauth_clients&ac=ajax_get_client_secret",function(result){
        $("input[name='client_secret']").val(result.data);
    });
});
</script>
</body>
