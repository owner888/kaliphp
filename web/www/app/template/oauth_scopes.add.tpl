                ...
                <form class="form-horizontal" id="validateForm" novalidate="novalidate" action="" method="POST">
                    ...
                    <div class="widget-content">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input name="name" type="text" class="form-control" datatype="*" nullmsg="请输入授权名称"/>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input name="scope" type="text" class="form-control" datatype="*" nullmsg="请输入授权域"/>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <div class="radio">
                                    ...
                                    <label>
                                        <input type="radio" value="0" name="is_default" checked /> 否
                                    </label>
                                </div>
                            </div>
                        </div>
