                            ...
                            <div class="col-sm-10">
                                ...
                                <div class="uploader-list">
                                    <div class="item img-item pull-left" style="margin-bottom:10px;margin-right:10px;">
                                        ...
                                        <input type="hidden" value="<{$v.image.filename}>" class="hid-filename" />
                                    </div>
                                    <input type="hidden" value="<{$v.image.filename}>" name="image" class="hid-filename list">
                                </div>
                        ...
                        <div class="form-group uploader-group uploader-group-img"  
                            ...
                            <div class="col-sm-10">
                                <div class="uploader-list">
                                    ...
                                    <div class="item img-item pull-left" style="margin-bottom:10px;margin-right:10px;">
                                        <img style="width:100px;height:100px;" src="<{$image.filelink}>" />
                                        <i class="fa fa-close close-btn"></i>
                                        <div class="progress progress-striped active" style="display: none;">
                                            <div class="progress-bar" role="progressbar" style="width: 100%;"></div>
                                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <div class="total-wrap" style="position: relative">
                                    <textarea id="redactor_content" name="content" cols="30" rows="10" class="form-control"><{$v.content}></textarea>
                                </div>
                            </div>
                        </div>
