 ...
 *      $mail->setEmailName("xxxxx");                                              // 设置邮箱昵称，会在收件显示：3k玩<yangzetao@kkk5.com>
...
class cls_mail {
    ...
    {
        $this->_emailName = mb_convert_encoding($emailName, "gbk", "utf-8");
    }
    ...
    protected function getCommand() {
        ...
        //设置发件人
        $command[] = array("MAIL FROM: {$this->_emailName}<" . $this->_from . ">\r\n", 250);
        $header = "FROM: {$this->_emailName}<" . $this->_from . ">\r\n";
